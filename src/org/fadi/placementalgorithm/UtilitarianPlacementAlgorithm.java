...
public class UtilitarianPlacementAlgorithm extends ServerPlacementAlgorithm {
	...
	public LinkedList<Node> initializePacketsCountersMedium(LinkedList<Node> nodes, int distribution){
		...
		for(int i=0;i<1000; i++) {
			...
			weightOfPacket ++; // one subscriber is interested in all P values
			if((number >=20)&&(number<=30)) {
				weightOfPacket ++;
				nodes.get(9).setPacketsHandled(nodes.get(9).getPacketsHandled()+ weightOfPacket);
			}
			if((number>=30)&&(number<=40)) {
				weightOfPacket++;
				nodes.get(7).setPacketsHandled(nodes.get(7).getPacketsHandled()+ weightOfPacket);
			}
			nodes.get(8).setPacketsHandled(nodes.get(8).getPacketsHandled()+ weightOfPacket);
			nodes.get(6).setPacketsHandled(nodes.get(6).getPacketsHandled()+ weightOfPacket);
			nodes.get(1).setPacketsHandled(nodes.get(1).getPacketsHandled()+ weightOfPacket);
			nodes.get(5).setPacketsHandled(nodes.get(5).getPacketsHandled()+ weightOfPacket);
		}
		// end of P1 section
		...
		for(int i=0;i<1000;i++) {
			...
			weightOfPacket = weightOfPacket+2; // 2 subscribers are interested in all T value
			
			if(number<0) {
				weightOfPacket +=2; // 2 subscribers are interested in T<0
				nodes.get(14).setPacketsHandled(nodes.get(14).getPacketsHandled()+weightOfPacket);
				nodes.get(24).setPacketsHandled(nodes.get(24).getPacketsHandled()+weightOfPacket);
			}
			if(number>40) {
				weightOfPacket +=2; // 2 subscribers are interested in T>40
				nodes.get(10).setPacketsHandled(nodes.get(10).getPacketsHandled()+weightOfPacket);
				nodes.get(22).setPacketsHandled(nodes.get(22).getPacketsHandled()+weightOfPacket);
			}
			if((number>=10)&&(number<=15)) {
				weightOfPacket ++;
				nodes.get(12).setPacketsHandled(nodes.get(12).getPacketsHandled()+weightOfPacket);
			}
			if(number<15) {
				weightOfPacket ++;
				nodes.get(15).setPacketsHandled(nodes.get(15).getPacketsHandled()+weightOfPacket);
			}
			if(number>15) {
				weightOfPacket++;
				nodes.get(19).setPacketsHandled(nodes.get(19).getPacketsHandled()+weightOfPacket);
			}
			if((number>=10)&&(number<=20)) {
				weightOfPacket++;
				nodes.get(23).setPacketsHandled(nodes.get(23).getPacketsHandled()+weightOfPacket);
			}
			nodes.get(13).setPacketsHandled(nodes.get(13).getPacketsHandled()+weightOfPacket);
			nodes.get(11).setPacketsHandled(nodes.get(11).getPacketsHandled()+weightOfPacket);
			nodes.get(3).setPacketsHandled(nodes.get(3).getPacketsHandled()+weightOfPacket);
			nodes.get(0).setPacketsHandled(nodes.get(0).getPacketsHandled()+weightOfPacket);
			nodes.get(2).setPacketsHandled(nodes.get(2).getPacketsHandled()+weightOfPacket);
			nodes.get(20).setPacketsHandled(nodes.get(20).getPacketsHandled()+weightOfPacket);
			nodes.get(4).setPacketsHandled(nodes.get(4).getPacketsHandled()+weightOfPacket);
			nodes.get(17).setPacketsHandled(nodes.get(17).getPacketsHandled()+weightOfPacket);
			nodes.get(16).setPacketsHandled(nodes.get(16).getPacketsHandled()+weightOfPacket);
			nodes.get(18).setPacketsHandled(nodes.get(18).getPacketsHandled()+weightOfPacket);
		}
		// end of P2 section
		...
		for (int i=0; i<1000; i++) {
			...
			weightOfPacket +=2; // 2 subscribers are interested in all T values
			if(number >15) {
				weightOfPacket++;
				nodes.get(19).setPacketsHandled(nodes.get(19).getPacketsHandled()+weightOfPacket);
			}
			...
			if( ((number>=10)&&(number<=20))||(number<0)){
				...
				nodes.get(21).setPacketsHandled(nodes.get(21).getPacketsHandled()+weightOfPacket);
			}
			nodes.get(18).setPacketsHandled(nodes.get(18).getPacketsHandled()+weightOfPacket);
			nodes.get(16).setPacketsHandled(nodes.get(16).getPacketsHandled()+weightOfPacket);
			nodes.get(4).setPacketsHandled(nodes.get(4).getPacketsHandled()+weightOfPacket);
